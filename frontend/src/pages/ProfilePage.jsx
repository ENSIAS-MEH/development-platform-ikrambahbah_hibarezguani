...
function ProfilePage() {
  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      if (isOwnProfile) {
        ...
        console.log("✅ Son propre profil:", data);
      } else {
        // ✅ Profil d'un autre utilisateur
        data = await getProfileByUserId(targetUserId);
        console.log(`✅ Profil de l'utilisateur ${targetUserId}:`, data);
      }
      setProfile(data);
    } catch (err) {
  ...
  // ✅ Gestionnaire de clic sur le bouton message
      ...
      <div className="profile-wrapper">
        ...
        <div className="profile-card">
          ...
          <div className="profile-info">
            ...
            {/* ✅ Boutons conditionnels selon que c'est son profil ou non */}
            {isOwnProfile ? (
          ...
          <div className="profile-card">
            <div className="profile-section">
              <div className="section-header">
                ...
                {isOwnProfile && (
                  <button className="add-button" onClick={() => navigate("/profile/edit")}>
                    Modifier
                  </button>
                )}
              </div>
              ...
              <div className="about-section">
                ...
                <div className="links-list">
                  {profile.linkedinUrl && (
                    <a href={profile.linkedinUrl} target="_blank" rel="noopener noreferrer" className="about-link">
                      🔗 LinkedIn
                    </a>
                  )}
                  {profile.githubUrl && (
                    <a href={profile.githubUrl} target="_blank" rel="noopener noreferrer" className="about-link">
                      💻 GitHub
                    </a>
                  )}
                  {profile.websiteUrl && (
                    <a href={profile.websiteUrl} target="_blank" rel="noopener noreferrer" className="about-link">
                      🌐 Site web
                    </a>
                  )}
          ...
          <div className="profile-card">
            <div className="profile-section">
              <div className="section-header">
                ...
                {isOwnProfile && (
                  <button className="add-button" onClick={() => navigate("/profile/skills")}>
                    + Gérer
                  </button>
                )}
              </div>
          ...
          <div className="profile-card">
            <div className="profile-section">
              <div className="section-header">
                ...
                {isOwnProfile && (
                  <button className="add-button" onClick={() => navigate("/profile/experience")}>
                    + Ajouter
                  </button>
                )}
              </div>
          ...
          <div className="profile-card">
            <div className="profile-section">
              <div className="section-header">
                ...
                {isOwnProfile && (
                  <button className="add-button" onClick={() => navigate("/profile/education")}>
                    + Ajouter
                  </button>
                )}
              </div>
